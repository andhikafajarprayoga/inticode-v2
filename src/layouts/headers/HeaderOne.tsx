              ...
              <div className="cs_box_two">
                <div>
                  <p>
                    ...
                    <span className="ms-2">Kota Bandung</span>
                  </p>

                  <h4 className="cs_phone_number">
                    <a href="tel:085963160777">
                      <svg
                        width="35"
                        height="35"
                        viewBox="0 0 18 19"
                      ...
                      <span className="ms-2">085963160777</span>
                    </a>
                  </h4>
                  ...
                  <h2>
                    <a
                      href="mailto:andhikafajarprayoga@gmail.com"
                      className="cs_primary_font cs_text_btn"
                    >
                      <span className="cs_black">
                        andhikafajarprayoga@gmail.com
                      </span>
                    </a>
                  </h2>
                </div>
