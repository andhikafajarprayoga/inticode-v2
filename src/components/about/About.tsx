...
import agency_story_2 from "@/assets/img/agency_storyy_2.jpg";
...
const about_content: DataType = {
  subtitle: `Tentang Inticode.store`,
  title: `Solusi IT Terintegrasi untuk Bisnis Anda`,
  des: `Inticode.store adalah partner terpercaya untuk kebutuhan IT Solution bisnis Anda. Kami menyediakan layanan pembuatan website, aplikasi, sistem informasi, hingga konsultasi dan pengembangan teknologi sesuai kebutuhan. Percayakan transformasi digital bisnis Anda bersama tim profesional kami.`,
};
